...
class System extends IController
{
    ...
    */
	...
	function conf_base($form_index = null)
	{
		...
		$configArray['form_index'] = IReq::get('form_index') ? IFilter::act(IReq::get('form_index')) : $form_index;
	...
	{
		$theme  = IFilter::string(IReq::get('theme'));
		$client = IFilter::string(IReq::get('client'));
		$skin   = null;

		if($theme && $client)
		{
			Common::applyTheme(array($client => $theme));
		}
